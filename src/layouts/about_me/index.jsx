...
import one from '../../assets/img/nat-1-large.jpg'
import two from '../../assets/img/nat-2-large.jpg'
import three from '../../assets/img/nat-3-large.jpg'
      ...
      <Section>
        ...
        <Information>
          <Details>
            ...
            <h3>My experience</h3>
            <p>I have experience with a lot of technologies, most of them related to JavaScript, specially ReactJS, React Native and NodeJS.</p>  
